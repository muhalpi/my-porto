...
export type PortfolioContent = {
  ...
  about: {
    ...
    image: string;
    imageAlt: string;
    badges: { eyebrow: string; title: string; detail: string }[];
  };
  skills: {
    heading: string;
    description: string;
  ...
  footer: {
    ...
    socials: { type: "github" | "linkedin" | "mail"; href: string; label: string }[];
  };
};
...
export const defaultPortfolioContent: PortfolioContent = {
  ...
  about: {
    ...
    image: "/profile-main.webp",
    imageAlt: "Muhammad Alfi portrait",
    badges: [
      { eyebrow: "Certified", title: "Adobe Professional", detail: "ACP 2024" },
      { eyebrow: "Education", title: "S1 Accounting", detail: "GPA 3.79 / 4.00" },
    ],
  },
  skills: {
    ...
    groups: [
      {
        ...
        skills: [
          ...
          { name: "TikTok", icon: "tiktok", color: "#69C9D0" },
  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "An ATS-friendly CV generator built to help Indonesian job seekers create clean, professional resumes that pass applicant tracking systems. Designed with simplicity and local context in mind.",
      ...
      },
      {
        ...
        description:
          "An online shop for digital products and needs. Curated digital goods delivered instantly - built to serve a growing market of Indonesian digital consumers looking for fast, reliable access to digital resources.",
      ...
      },
      {
        ...
        description:
          "A digital marketing consultancy helping small businesses and entrepreneurs build their online presence - from social media strategy to paid ads, branding, and content creation.",
  ...
  gallery: {
    heading: "Gallery.",
    description: "Highlights from my content, event, and brand activation work.",
    items: [
      {
  ...
  experience: {
    ...
    certifications: [
      ...
      {
        name: "Ujian Standar Keahlian Akuntansi Dasar",
        org: "IAI Jawa Timur",
        year: "2025",
      },
      {
        name: "Marketing Analyst Academy (MAA) Batch 9",
        org: "SLC Marketing, Inc.",
        year: "2022",
      },
  ...
  contact: {
    ...
    email: "alpi.muh@gmail.com",
    linkedinLabel: "LinkedIn",
    linkedinUrl: "https://linkedin.com/in/muhammad-alfi/",
  },
  footer: {
    brandLabel: "m.alpi",
    copyrightName: "Muhammad Alfi",
    socials: [
      { type: "github", href: "https://github.com/muhalpi", label: "GitHub" },
      { type: "linkedin", href: "https://linkedin.com/in/muhammad-alfi/", label: "LinkedIn" },
      { type: "mail", href: "mailto:alpi.muh@gmail.com", label: "Email" },
    ],
  },
};

export function contentDataUrl() {
  return `${import.meta.env.BASE_URL}portfolio-content.json`;
}
